...
namespace stm32util::reg {
    ...
    namespace detail {
        ...
        template<BitPositionAndState const &CurrentBitPositionAndState, BitPositionAndState const &NextBitPositionAndState, BitPositionAndState const &... RemainingBitPositionsAndStates>
        constexpr uint32_t clearMaskNot() {
            return mask<CurrentBitPositionAndState.position, !CurrentBitPositionAndState.state>() | clearMaskNot<NextBitPositionAndState, RemainingBitPositionsAndStates...>();
        }
        ...
        template<BitPositionAndState const &CurrentBitPositionAndState, BitPositionAndState const &NextBitPositionAndState, BitPositionAndState const &... RemainingBitPositionsAndStates>
        constexpr uint32_t setMask() {
            return mask<CurrentBitPositionAndState.position, CurrentBitPositionAndState.state>() | setMask<NextBitPositionAndState, RemainingBitPositionsAndStates...>();
        }
